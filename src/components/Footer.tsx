...
import { ArrowRight, Check, Terminal, Phone, Mail, MessageSquare, MapPin } from 'lucide-react';
  ...
  const navColumns = [
    {
      ...
      links: [
        ...
        { label: 'Verified Pricing', path: '/pricing' },
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Customer Support 24/7', path: '/customer-support' },
        { label: 'Branding & Identity', path: '/services/branding' },
        { label: 'Instagram Growth', path: '/services/digital-marketing' },
        { label: 'Reels & Shoots', path: '/services/content-creation-shoots' },
        { label: 'Digital Growth (₹35k)', path: '/pricing' },
      ],
    },
    {
      title: 'LOCAL MARKETS',
      links: [
        { label: 'Bulandshahr (HQ)', path: '/locations/bulandshahr' },
        { label: 'Noida Hub', path: '/locations/noida' },
        { label: 'Greater Noida', path: '/locations/greater-noida' },
        { label: 'Gurugram (Cyber City)', path: '/locations/gurugram' },
        { label: 'Delhi NCR Area', path: '/locations/delhi-ncr' },
        { label: 'Hapur & Khurja', path: '/locations/hapur' },
        { label: 'Aligarh & Sikandrabad', path: '/locations/aligarh' },
      ],
    },
    {
      title: 'SOLUTIONS',
      links: [
        { label: 'Startup Launch Kit', path: '/pricing' },
        { label: 'D2C E-Commerce Growth', path: '/services/ecommerce' },
        { label: 'Support Outsourcing', path: '/customer-support' },
        { label: 'Local Google Maps SEO', path: '/blog/how-local-businesses-rank-on-google-maps' },
        { label: 'Website Cost Calculator', path: '/blog/how-much-does-a-business-website-cost-in-india' },
        { label: 'Free Consultation', action: onOpenContact },
      ],
    },
  ];

  return (
    <footer className="relative w-full min-h-[950px] bg-[#020510] text-white overflow-hidden border-t border-blue-950/70 font-mono select-none">
      
      {/* 1. CINEMATIC BUNNY MASCOT BACKGROUND (ADAPTIVE DESKTOP & MOBILE TUNING) */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Desktop & Tablet: High-Fidelity Far-Right Positioning */}
        <div
        ...
        {/* Mobile: Subtle Top-Right Ambient Mascot Silhouette */}
        <div
        ...
        {/* Ambient Gradient across left & center */}
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-20 sm:pt-28 pb-20 md:pb-12 flex flex-col justify-between min-h-[880px]">
        ...
        <div className="w-full lg:max-w-[70%]">
          ...
          <div className="mb-12">
            ...
            <p className="text-xs sm:text-sm text-zinc-300 max-w-xl leading-relaxed mb-6">
              A creative digital agency and customer support partner helping businesses and startups build high-performance websites, distinctive brands, and scalable growth systems across India and global markets.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs font-mono">
              ...
              <div className="px-3.5 py-1.5 rounded-full bg-zinc-950/60 border border-zinc-700/50 text-zinc-400 flex items-center gap-2">
                <MapPin className="w-3.5 h-3.5 text-blue-400" />
                <span>HQ: Bulandshahr, UP</span>
              </div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                  <div className="md:col-span-7">
                    ...
                    <p className="text-xs text-zinc-300 mt-1">
                      Have a project or customer support requirement? Let's talk today.
                    </p>
                  </div>
